...
/**
 * Upsert INSECTICIDE-GRUB SPRAY #1, INSECTICIDE SPRAY #2/#3
 * Usage: cd node_backendFandG && node scripts/upsert-insecticide-spray-mixes.js
 */
const mongoose = require("mongoose");
const { connectDB } = require("../config/db");
const ChemicalMaintenance = require("../modules/ChemicalMaintenance/Model/chemicalMaintenanceModel");
const { mixes } = require("./data/insecticideSprayMixes");

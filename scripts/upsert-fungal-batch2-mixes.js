...
/**
 * Upsert FUNGAL SPRAY #4–#7, FUNGAL DRENCH #1–#3, INSECTICIDE DRENCH #1
 * Usage: cd node_backendFandG && node scripts/upsert-fungal-batch2-mixes.js
 */
const mongoose = require("mongoose");
const { connectDB } = require("../config/db");
const ChemicalMaintenance = require("../modules/ChemicalMaintenance/Model/chemicalMaintenanceModel");
const { mixes, duplicateMixNamesToRetire } = require("./data/fungalSprayDrenchBatch2");

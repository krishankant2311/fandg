...
/** Normalize customerEmail: blank/invalid -> "", so we never save or return wrong/undefined email */
  ...
  try {
    ...
    if (staff) {
      ...
      if (project) {
        ...
        result.customerEmail = normalizeCustomerEmail(result.customerEmail);
        return res.send({
          statusCode: 200,
          success: true,
          message: "Project fetched successfully ",
  ...
  try {
    ...
    if (staff) {
      ...
      if (Object.prototype.hasOwnProperty.call(req.body, "customerEmail")) {
        req.body.customerEmail = normalizeCustomerEmail(req.body.customerEmail);
      }
  ...
  try {
    ...
    if (staff) {
      ...
      try {
        ...
        console.log("Forms array received:", forms);
        // Debug: Check if cost field is present
        if (forms.length > 0) {
          console.log("First form item:", forms[0]);
          console.log("Cost field in first item:", forms[0].cost);
          console.log("Markup field in first item:", forms[0].markup, forms[0].markUp);
        }

...
const connectDB = async () => {
    try {
        ...
        const connect = await mongoose.connect(`mongodb+srv://abhinandan_db_user:MqVfTUZp9pq1bR8G@cluster0.qtbcn0b.mongodb.net/fandgdummy?retryWrites=true&w=majority&appName=Cluster0`);
